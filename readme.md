...
### biathlon_update_old_olympic_games
Используется для ручного обновления данных об олимпийских играх в период с 1960 по 1980, когда олимпиада проводилась не под IBU. Данные берутся из файлов, файлы могут содержать ошибки, так как заполнялись в полуручном режиме.

### biathlon_update_fresh_race
Обновление гонки для которой статус стоит как завершена, но при этом нет результатов в базе данных.